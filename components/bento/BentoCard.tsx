...
const SPAN: Record<Span, string> = {
  ...
  5: 'col-span-1 md:col-span-8 lg:col-span-5',
  6: 'col-span-1 md:col-span-4 lg:col-span-6',
  7: 'col-span-1 md:col-span-8 lg:col-span-7',
  8: 'col-span-1 md:col-span-8 lg:col-span-8',
  12: 'col-span-1 md:col-span-8 lg:col-span-12',
};
