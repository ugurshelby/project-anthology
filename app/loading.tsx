...
export default function Loading() {
  return (
    <main id="main-content" className="mx-auto grid w-full max-w-[var(--container-max)] flex-1 grid-cols-1 gap-6 px-5 py-8 md:px-8 lg:grid-cols-12 lg:px-16 lg:py-12">
