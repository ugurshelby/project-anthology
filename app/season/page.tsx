        ...
        <section>
          ...
          {standings.length === 0 ? (
            ...
            <div className="overflow-x-auto border border-[var(--border)]">
              <table className="w-full min-w-[480px] text-left font-[family-name:var(--font-mono)] text-xs tracking-[0.05em]">
            ...
            <ul className="space-y-2">
              {races.map((race) => (
                ...
                >
                  <div>
                    <span
                      className="font-[family-name:var(--font-mono)] text-[9px] uppercase text-accent/70"
                      style={{ color: 'rgba(255,24,1,0.7)' }}
                    >
                      R{race.round ?? '—'}
                    </span>
                    <p
                      className="font-[family-name:var(--font-display)] text-[1.3rem] tracking-[0.04em]"
                      style={{ color: 'var(--paper)' }}
                    >
                      {race.raceName ?? 'Grand Prix'}
                    </p>
                  </div>
                  <span className="font-[family-name:var(--font-mono)] text-xs text-muted" style={{ color: 'var(--muted)' }}>
                    {race.date ?? '—'}
                  </span>
                </li>
              ))}
